...
1. Search Silver players of one nation with max bid 500 and min buy now 1000. The nation advances round-robin each pass through England, Germany and Italy, the three that paid off in the first evening of sniping (SNIPE_NATIONS in NationRotation.cs).
2. Page through every result page while rows are within 20 minutes of ending, including rows in their last minute. Price each candidate as usual and click Watch on every item whose minimum bid sits at or below the bid ceiling, until 15 items are watched.
