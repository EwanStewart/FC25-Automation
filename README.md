...
1. Search players with the next filter in the snipe ring (RING in Automation/SnipeFilters.cs), max bid 500 and min buy now 1000. A filter has a name, a quality and any of nationality, league, club and position. The web app only enables the Club dropdown once a league is chosen, so a club filter carries its league. Each search is recorded under the filter's name and the ring resumes after the last recorded name, so the filters take turns across runs.
   The ring was chosen on 18 September 2026: OM silvers, Scotland silvers, Scotland bronzes, then PSG silvers, the club filters both in Ligue 1. That week's Marquee Matchups squad Paris Saint-Germain v Olympique de Marseille asks for one PSG or OM player with silver quality or better, so the cheapest solution needs a silver from one of the two clubs, and both clubs have only a handful of silver cards. On the live market every sampled OM and PSG silver cleared the 1000 coin margin (6 of 6 and 3 of 3, second-lowest asks 1,700 to 3,500 against minimum bids of 300 to 550). England silvers cleared 0 of 5 live and 34 of 178 priced candidates that evening, with ask floors of 500 to 550. Scotland silvers, wanted by the Celtic v Rangers squad, have ask floors of 1,000 to 1,400 against minimum bids of 300 to 550: 9 of 13 sampled cards clear a 700 coin margin and 1 of 13 a 1000 coin one, which is why the margin was lowered to 700 the same evening. Scotland bronzes fit the same squad, which accepts bronze quality: their floors sit at 1,000 to 1,100 against minimum bids of 150 to 300, so 3 of 5 sampled cards clear the 700 margin. Marquee Matchups changes every Thursday at 18:00 UK time and this set expires on 24 September 2026, so the ring needs revisiting each week.
