...
1. Search players with the next filter in the snipe ring (RING in Automation/SnipeFilters.cs), max bid 500 and min buy now 1000. A filter has a name, a quality and any of nationality, league, club and position. The web app only enables the Club dropdown once a league is chosen, so a club filter carries its league. Each search is recorded under the filter's name and the ring resumes after the last recorded name, so the filters take turns across runs.
   The ring was chosen on 18 September 2026: Scotland bronzes, then Scotland silvers. That week's Marquee Matchups squad Celtic v Rangers asks for one Scotland player at minimum Bronze quality with only 14 chemistry, so it is the cheapest of the four squads and Scottish fodder of both qualities feeds it. Against minimum bids of 300 to 550, Scotland silvers have second-lowest asks of 1,000 to 1,400 and 9 of 13 sampled cards clear a 700 coin margin, 1 of 13 a 1000 coin one, which is why the margin was lowered to 700 the same evening. Scotland bronzes ask 1,000 to 1,100 against minimum bids of 150 to 300, so 3 of 5 sampled cards clear 700, with the thinnest headroom in the ring. England silvers, the previous filter, cleared 0 of 5 live and 34 of 178 priced candidates that evening, with ask floors of 500 to 550. Club filters were measured too and priced far better per card, but an OM or PSG search returns only 3 to 8 distinct cards with most rows beyond the 20 minute window, so the ring keeps the deeper Scotland pools. Marquee Matchups changes every Thursday at 18:00 UK time and this set expires on 24 September 2026, so the ring needs revisiting each week.
